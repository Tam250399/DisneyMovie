        ...
        <div>
            ...
            <div className="flex overflow-x-auto w-full px-16 py-4 scrollbar-none scroll-smooth" ref={elementRef}>
                {movieList.map((items) => (
                    ...
                    <img key={items.id} src={IMAGE_BASE_URL + items.backdrop_path} className="min-w-full md:h-[310px] object-cover object-left-top mr-5 hover:border-[4px] border-gray-400 transition-all duration-100 ease-in" />
                ))}
            </div>
        </div>
    )
